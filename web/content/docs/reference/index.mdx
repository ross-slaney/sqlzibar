...
| --- | --- |
| [Hosting API](/docs/reference/hosting-api) | `SqlOSDbContext<TContext>`, `AddSqlOS`, `UseSingleApplication` (`Api`, `Mcp`, `Brand`, `Authorization`), and token-protected route groups |
