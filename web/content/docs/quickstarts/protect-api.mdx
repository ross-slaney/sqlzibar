...
`RequireSqlOSAccessToken` remains the explicit alternative for hosts that do not use single-application mode or that protect several audiences; see the [Hosting API](/docs/reference/hosting-api#requiresqlosaccesstoken).
